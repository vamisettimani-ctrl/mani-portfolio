...
function ComputingCore() {
  ...
  return <group>
    ...
    {[[-1.65, 0.2, 0], [1.65, -0.2, 0], [0, 1.6, 0.2], [0, -1.6, -0.2]].map(([x, y, z], index) => <mesh key={index} position={[x, y, z]}><sphereGeometry args={[0.07, 12, 12]} /><meshStandardMaterial color="#f8fafc" emissive="#38bdf8" emissiveIntensity={1.5} /></mesh>)}
  </group>
}
