    ...
    <div className={dark ? 'portfolio dark' : 'portfolio light'}>
      ...
      <main id="top">
        <section className="hero page-section">
          ...
          <div className="hero-actions"><a className="primary-button" href="#work">Explore my work <ArrowUpRight size={17} /></a><a className="text-link" href="#contact">Get in touch <span>↗</span></a><a className="text-link resume-link" href="https://blobs.vusercontent.net/blob/CV%20Recommended%20Format%20mani%20%281%29-yxYPC7E56EBh2OEcm1OwJRkvq2i61q.pdf" target="_blank" rel="noreferrer" download="Mani-Sai-Sudheer-CV.pdf"><Download size={16} /> Download CV</a><a className="text-link profile-link" href="mailto:vamisettimani@gmail.com"><Mail size={16} /> Email</a><a className="text-link profile-link" href="https://www.linkedin.com/in/mani-sai-sudheer-vamisetti/" target="_blank" rel="noreferrer">LinkedIn <ExternalLink size={15} /></a><a className="text-link profile-link" href="https://github.com/vamisettimani-ctrl" target="_blank" rel="noreferrer">GitHub <ExternalLink size={15} /></a></div>
        ...
        <section id="skills" className="skills page-section split-section"><div className="section-label"><span>03</span><span>Capabilities</span></div><div className="section-content"><h2>Tools for<br /><em>making things work.</em></h2><div className="skills-showcase"><h3>Technical Skills</h3><div className="technical-skills"><div className="skill-card"><Code2 size={32} /><span>C++</span></div><div className="skill-card"><Code2 size={32} /><span>Python</span></div><div className="skill-card"><Code2 size={32} /><span>C</span></div><div className="skill-card"><Code2 size={32} /><span>HTML</span></div><div className="skill-card"><Code2 size={32} /><span>CSS</span></div><div className="skill-card"><Code2 size={32} /><span>JavaScript</span></div><div className="skill-card"><Code2 size={32} /><span>MySQL</span></div><div className="skill-card"><Code2 size={32} /><span>Git &amp; GitHub</span></div><div className="skill-card"><Code2 size={32} /><span>Figma</span></div></div><h3>Soft Skills</h3><div className="soft-skills"><div className="skill-card"><span>Problem-solving</span></div><div className="skill-card"><span>Project management</span></div><div className="skill-card"><span>Adaptability</span></div></div></div><div className="certificate-section"><div className="certificate-heading"><small>04 / Certificates</small><p>Selected learning milestones and verified technical foundations.</p></div><div className="certificate-grid"><article className="certificate-card"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-WaZ3gZxcLbzhNvReewUpZFoaAPGiff.png" alt="Infosys SpringBoard Introduction to Artificial Intelligence certificate" /><div className="certificate-card-body"><span>Infosys SpringBoard</span><h3>Introduction to Artificial Intelligence</h3><a className="card-link" href="https://drive.google.com/file/d/1tN0E_DHPVNV3c_uAdv7IqmS8FI0Yp2uK/view?usp=sharing" target="_blank" rel="noreferrer">View certificate <ExternalLink size={13} /></a></div></article><article className="certificate-card"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-hBuLKTr4Dlykwi8931cwkFyfSyFeZJ.png" alt="LearnVern C Language certificate" /><div className="certificate-card-body"><span>LearnVern</span><h3>C Language Course</h3><a className="card-link" href="https://drive.google.com/file/d/1WBDw3ZX_q3bEkCra-asKxVAyUN0HLyyD/view?usp=sharing" target="_blank" rel="noreferrer">View certificate <ExternalLink size={13} /></a></div></article><article className="certificate-card"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-U448VfY3rExrBt5AumwJ787IfUxUwf.png" alt="EduTech Hub Leadership Fundamentals certificate" /><div className="certificate-card-body"><span>EduTech Hub</span><h3>Leadership Fundamentals</h3><a className="card-link" href="https://drive.google.com/file/d/114ZgxJsojfV6tWmgLNhLdtXUDt5p3QLI/view?usp=sharing" target="_blank" rel="noreferrer">View certificate <ExternalLink size={13} /></a></div></article></div></div><div className="education-note"><small>Education</small><div className="education-list"><article><span>2025 — Present</span><h3>Bachelor of Technology</h3><p>Computer Science and Engineering<br />Lovely Professional University · Phagwara, Punjab<br />CGPA: 8.2</p></article><article><span>Mar 2023 — May 2025</span><h3>Intermediate</h3><p>PCM<br />Sri Chaitanya Educational Institutions · Vijayawada, Andhra Pradesh<br />Percentage: 95.7%</p></article><article><span>March 2022 — March 2023</span><h3>Matriculation</h3><p>Sri Chaitanya Techno School · Jangareddy Guddem, Andhra Pradesh<br />Percentage: 92.3%</p></article></div></div></div></section>
      ...
      <footer><span>© {new Date().getFullYear()} Mani Sai Sudheer</span><span>Designed & built with intent.</span><div className="socials"><a href="https://github.com/vamisettimani-ctrl" target="_blank" rel="noreferrer" aria-label="GitHub"><Code2 size={17} /></a><a href="https://www.linkedin.com/in/mani-sai-sudheer-vamisetti/" target="_blank" rel="noreferrer" aria-label="LinkedIn"><BriefcaseBusiness size={17} /></a><a href={`mailto:${email}`} aria-label="Email"><Mail size={17} /></a><a href="https://blobs.vusercontent.net/blob/CV%20Recommended%20Format%20mani%20%281%29-yxYPC7E56EBh2OEcm1OwJRkvq2i61q.pdf" target="_blank" rel="noreferrer" aria-label="Download CV"><Download size={17} /></a></div></footer>
