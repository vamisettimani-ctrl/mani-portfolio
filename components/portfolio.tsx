    ...
    <div className={dark ? 'portfolio dark' : 'portfolio light'}>
      ...
      <main id="top">
        <section className="hero page-section">
          ...
          <div className="hero-actions"><a className="primary-button" href="#work">Explore my work <ArrowUpRight size={17} /></a><a className="text-link" href="#contact">Get in touch <span>↗</span></a><a className="text-link resume-link" href="https://blobs.vusercontent.net/blob/CV%20Recommended%20Format%20mani%20%281%29-yxYPC7E56EBh2OEcm1OwJRkvq2i61q.pdf" target="_blank" rel="noreferrer" download="Mani-Sai-Sudheer-CV.pdf"><Download size={16} /> Download CV</a></div>
